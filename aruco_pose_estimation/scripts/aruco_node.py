...
class ArucoNode(rclpy.node.Node):
    ...
    def image_callback(self, img_msg: Image):
        ...
        if len(markers.marker_ids) > 0:
            ...
            try:
                target_transform = self.tfBuffer.lookup_transform('camera_color_frame', 'camera_color_optical_frame', rclpy.time.Time(seconds=(0.0)))
                first_pose   = tf2_geometry_msgs.do_transform_pose(first_pose, target_transform) 
            ...
            # print(
            #     "ARUCO POSE ORIENTATION w: {0}, x: {1}, y: {2}, z: {3}".format(
            ...
            t_goal.transform.translation.x = 0.0 
            t_goal.transform.translation.y = 2.5 
            t_goal.transform.translation.z = 3.0

            t_goal.transform.rotation.x = 0.5
            t_goal.transform.rotation.y = 0.5
            t_goal.transform.rotation.z = -0.5
            t_goal.transform.rotation.w = 0.5
